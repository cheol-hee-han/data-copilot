...
도구 호출 없음 — 실행은 knowledge_fetcher에 위임한다.
...
async def reasoning_preparer_node(state: PipelineState) -> dict:
    ...
    reason.last_verdict = None
    reason.recovery_entry_source = None
    reason.inference_notes = []
    reason.conflicted_bounce_count = 0
    ...
    reason.execution_plan = _build_execution_plan(
        knowledge_items, searched_queries, nq,
