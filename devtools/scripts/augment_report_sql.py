...
DOMAIN_REPORTS: dict[str, list[tuple[str, list[str], str, str]]] = {
    ...
    "CUS": [
        ...
        (
            ...
            " JOIN ADWOWN.tb_adw_com001m b ON c.blng_brcd = b.blng_brcd"
        ...
        (
            ...
            " FROM ADWOWN.tb_adw_csc101m c"
            " JOIN ADWOWN.tb_adw_csp103m p ON c.edps_csn = p.edps_csn"
        ...
        (
            ...
            " FROM ADWOWN.tb_adw_csc102h h"
            " JOIN ADWOWN.tb_adw_csc101m c ON h.edps_csn = c.edps_csn"
            " WHERE c.std_dt = CURRENT_DATE"
        ...
        (
            ...
            " FROM ADWOWN.tb_adw_csc101m c"
            " LEFT JOIN ADWOWN.tb_adw_dep201p d ON c.edps_csn = d.edps_csn"
            "  AND d.std_dt = CURRENT_DATE"
            " LEFT JOIN ADWOWN.tb_adw_lnb301m l ON c.edps_csn = l.edps_csn"
    ...
    "DEP": [
        ...
        (
            ...
            " FROM ADWOWN.tb_adw_dep201p p"
            " JOIN ADWOWN.tb_adw_dep202s s ON p.acn = s.acn"
        ...
        (
            ...
            " JOIN ADWOWN.tb_adw_com001m b ON d.blng_brcd = b.blng_brcd"
    ...
    "LON": [
        ...
        (
            ...
            " FROM ADWOWN.tb_adw_lnb301m l"
            " JOIN ADWOWN.tb_adw_lnb302m r ON l.ln_no = r.ln_no"
    ...
    "TRX": [
        ...
        (
            ...
            " FROM ADWOWN.tb_adw_trx701l t"
            " JOIN ADWOWN.tb_adw_com001m b ON t.blng_brcd = b.blng_brcd"
    ...
    "FND": [
        ...
        (
            ...
            "  AND fund_cd IN (SELECT fund_cd FROM ADWOWN.tb_adw_fnb601m"
            "   WHERE std_dt = CURRENT_DATE"
    ...
    "MKT": [
        ...
        (
            ...
            " LEFT JOIN ADWOWN.tb_adw_mkt1202m r"
